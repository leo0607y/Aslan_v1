...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : Side_L_Pin Side_R_Pin */
  GPIO_InitStruct.Pin = Side_L_Pin|Side_R_Pin;
  ...
  /*Configure GPIO pins : Enc_l_A_Pin Enc_l_B_Pin */
  ...
  /*Configure GPIO pins : Enc_r_A_Pin Enc_r_B_Pin */
